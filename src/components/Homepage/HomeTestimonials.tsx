...
//                         <h2>Voices from Clinical Trials Learners</h2>

//                         <p className="h6 text-rg">Real insights before your DhatuAcademy journey begins</p>
//                     </div>

//                     <div className="testimonial-wrapper">
//                         <div className="testimonial-lists">
//                             <div className="testi-list site-radius-20 tilt-up">
//                                 <div className="testi-list-inner-box">
//                                     <div className="name-desig">
//                                         <span className="name-initial text-18">{testimonialDetails[0].nameInitial}</span>

//                                         <div className="">
//                                             <p className="name h5 text-md">{testimonialDetails[0].name}</p>
        
//                                             <p className="designation text-18">{testimonialDetails[0].designation}</p>
//                                         </div>
//                                     </div>
...
//                             <div className="testi-list site-radius-20">
//                                 <div className="testi-list-inner-box">
//                                     <div className="name-desig">
//                                         <span className="name-initial text-18">{testimonialDetails[1].nameInitial}</span>

//                                         <div className="">
//                                             <p className="name h5 text-md">{testimonialDetails[1].name}</p>
        
//                                             <p className="designation text-18">{testimonialDetails[1].designation}</p>
//                                         </div>
//                                     </div>
...
//                             <div className="testi-list site-radius-20 tilt-down">
//                                 <div className="testi-list-inner-box">
//                                     <div className="name-desig">
//                                         <span className="name-initial text-18">{testimonialDetails[2].nameInitial}</span>

//                                         <div className="">
//                                             <p className="name h5 text-md">{testimonialDetails[2].name}</p>
        
//                                             <p className="designation text-18">{testimonialDetails[2].designation}</p>
//                                         </div>
//                                     </div>
...
//                                 <div className="name">
//                                     <p className="h5 text-md">{testimonialDetails[3].name}</p>

//                                     <p className="text-18 text-rg">{testimonialDetails[3].designation}</p>
//                                 </div>
...
//                             <p className="h5 text-md">{testimonialDetails[3].message}</p>
//                         </div>
