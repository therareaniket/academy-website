...
export default function TrialGrowth(){
    ...
    const homeCertificatesAnimations = (typeof window !== "undefined" && window.innerWidth >= 1200) ? {
        ...
        img_rtl_animate: { x: "0px", opacity: 1, transition: { delay: 3, duration: 0.6 } },
            ...
            <section className="section">
                <div className="container">
                    ...
                    <div className="certificate-usp">
                        <motion.div className="certifi-usp" initial={homeCertificatesAnimations.usp_list_initial} whileInView={homeCertificatesAnimations.usp_list_animate} viewport={{ once: true }} transition={{delay: isMobile ? 1 : 3.5, duration: 0.6 }}>
                            <span>
