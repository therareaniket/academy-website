...
export default function TrialGrowth(){
    ...
    const homeCertificatesAnimations = {
        ...
        img_rtl_animate: { x: "0px", opacity: 1, transition: { delay: 3, duration: 1 } },
            ...
            <section className="section">
                <div className="container">
                    <div className="trial-grwth-wrapper">
                        ...
                        <motion.div className="certifi-img-wrapper" initial={homeCertificatesAnimations.img_rtl_initial} whileInView={homeCertificatesAnimations.img_rtl_animate} viewport={{ once: true, amount: 0.8 }}>
                    ...
                    <div className="certificate-usp">
                        <motion.div className="certifi-usp" initial={homeCertificatesAnimations.usp_list_initial} whileInView={homeCertificatesAnimations.usp_list_animate} viewport={{ once: true }} transition={{delay: 3.5, duration: 1 }}>
                            <span>
