...
export default function ContactForm( {contactFormTitle, contactFormSubtitle, contactEmail, contactPhone, contactAddress}:ContactFormProps ) {
    ...
    const contactTitleAnimations = (typeof window !== "undefined" && window.innerWidth >= 1200) ? {
        ...
        image_rtl_initial: { x: "50px", opacity: 0, },
		image_rtl_animate: { x: "0px", opacity: 1, transition: { delay: 0.5, duration: 0.6 } },
    }
                    ...
                    <div className="contact-form-wrapper">
                        ...
                        <div className="contact-form-right">
                            ...
                            <motion.div className="form-cards-main"  initial="hidden" whileInView="visible" viewport={{ once: true, amount: isMobile ? 0.6 : 0.5 }} variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.5,} } }}>
                                <motion.div className="form-cards email-card site-radius-20" variants={contactCardsAnimation} transition={{  duration: 1, delay: isMobile ? 0.5 : 1  }}>
                                ...
                                <motion.div className="form-cards phone-card site-radius-20" variants={contactCardsAnimation} transition={{  duration: 1, delay: isMobile ? 0.5 : 1  }}>
                                ...
                                <motion.div className="form-cards location-card site-radius-20" variants={contactCardsAnimation} transition={{  duration: 1, delay: isMobile ? 0.5 : 1  }}>
